...
/* ── Interface version ──────────────────────────────────────────────────── */
#define NET_SVC_INTERFACE_VERSION       5

/* ── Geometry / limits ──────────────────────────────────────────────────── */
#define NET_SVC_MAX_VNICS               16u
#define NET_SVC_MAX_BOUND_PORTS         8u
#define NET_SVC_MAX_FRAME_BYTES         1514u
#define NET_SVC_SHMEM_TOTAL             0x800000u  /* three clients plus driver page */
#define NET_SVC_SLOT_BASE               0x600000u  /* driver-only transfer page */
