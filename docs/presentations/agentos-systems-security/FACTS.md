...
| Pinned Debian boots through agentOS-owned net, block and console | Live proof passed; acquisition and gate merged in PR #150 | Retained `first-dce5b02` image SHA-256 `a2f9f5c49e657d9477ea4d1d877edbced6359601b5fe5fed820a4f8e3cca9061`; console and authenticated SSH transcript | A single boot with disposable snapshots does not prove persistence. Lifecycle parity, two-boot persistence, same-runner timing and amd64 remain separate requirements. |
