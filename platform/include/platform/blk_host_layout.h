...
#define AGENTOS_HOST_FREEBSD_BLK_PAGE_PA   AGENTOS_HOST_SECONDARY_BLK_PAGE_PA
#define AGENTOS_HOST_FREEBSD_BLK_PAGE_VA   AGENTOS_HOST_SECONDARY_BLK_PAGE_VA
#define AGENTOS_HOST_FREEBSD_BLK_PAGE_OFF  AGENTOS_HOST_SECONDARY_BLK_PAGE_OFF
...
#define AOS_HOST_BLK_MEDIA_UBUNTU          AOS_HOST_BLK_MEDIA_PRIMARY
#define AOS_HOST_BLK_MEDIA_FREEBSD         AOS_HOST_BLK_MEDIA_SECONDARY
