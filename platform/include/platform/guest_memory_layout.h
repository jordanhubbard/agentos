...
#define AOS_FREEBSD_GUEST_GPA_BASE       AOS_SECONDARY_GUEST_GPA_BASE
#define AOS_LINUX_GUEST_RAM_BASE         AOS_PRIMARY_GUEST_RAM_BASE
#define AOS_FREEBSD_GUEST_RAM_BASE       AOS_SECONDARY_GUEST_RAM_BASE
...
#define AOS_FREEBSD_GUEST_RAM_SIZE       AOS_SECONDARY_GUEST_RAM_SIZE
#define AOS_LINUX_GUEST_DTB_BASE         AOS_PRIMARY_GUEST_DTB_BASE
#define AOS_FREEBSD_GUEST_DTB_BASE       AOS_SECONDARY_GUEST_DTB_BASE
#define AOS_LINUX_GUEST_INITRD_BASE      AOS_PRIMARY_GUEST_INITRD_BASE
#define AOS_LINUX_GUEST_RAM_MB           AOS_PRIMARY_GUEST_RAM_MB
#define AOS_FREEBSD_GUEST_RAM_MB         AOS_SECONDARY_GUEST_RAM_MB
