...
#if (defined(AGENTOS_BLK_ISOLATION_PROBE) + defined(AGENTOS_NET_ISOLATION_PROBE) + defined(AGENTOS_SERIAL_ISOLATION_PROBE)) > 1
...
#elif defined(AGENTOS_SERIAL_ISOLATION_PROBE)
#define AOS_VMM_ISOLATION_PROBE AGENTOS_SERIAL_ISOLATION_PROBE
#define AOS_VMM_PROBE_MESSAGE "[rt] serial isolation: expected VMM data fault verified\n"
#define AOS_VMM_PROBE_OWN_ADDRESS (AOS_SERIAL_SHMEM_VA + AOS_VMM_PROBE_CLIENT * AOS_SERIAL_FRAME_SIZE)
#define AOS_VMM_PROBE_ADDRESS \
    (AOS_SERIAL_SHMEM_VA + (AOS_VMM_PROBE_OPERATION < 2 \
        ? (1u - AOS_VMM_PROBE_CLIENT) * AOS_SERIAL_FRAME_SIZE \
