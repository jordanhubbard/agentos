...
#define AOS_NET_NATIVE_CLIENT        2u
#define AOS_NET_QUEUE_CLIENTS        3u
#define AOS_NET_SHMEM_FRAME_SIZE     0x200000u /* seL4 large page */
#define AOS_NET_CLIENT_STRIDE        AOS_NET_SHMEM_FRAME_SIZE
#define AOS_NET_DRIVER_FRAME         AOS_NET_QUEUE_CLIENTS
#define AOS_NET_SHMEM_FRAMES         (AOS_NET_QUEUE_CLIENTS + 1u)
