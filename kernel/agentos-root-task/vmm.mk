...
UBUNTU_BOOTARGS := console=hvc0 quiet loglevel=3 boot=casper noprompt systemd.show_status=false systemd.unit=console-getty.service systemd.wants=systemd-user-sessions.service systemd.mask=ldconfig.service systemd.mask=systemd-udev-trigger.service systemd.mask=systemd-udevd.service systemd.mask=systemd-sysusers.service systemd.mask=systemd-resolved.service systemd.mask=netplan-configure.service panic=-1
else
